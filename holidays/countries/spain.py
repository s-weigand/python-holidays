...
class Spain(HolidayBase):
    ...
    def _populate(self, year):
        ...
        if (
            year < 2015
            and self.prov
            and self.prov in ["AR", "CL", "CM", "EX", "GA", "MD", "ML", "MC", "NC", "PV", "VC"]
        ):
            self[date(year, MAR, 19)] = "San José"
        elif (
            year == 2015 and self.prov and self.prov in ["CM", "MD", "ML", "MC", "NC", "PV", "VC"]
        ):
            self[date(year, MAR, 19)] = "San José"
            ...
            self[date(year, MAR, 19)] = "San José"
        elif 2018 <= year <= 2019 and self.prov and self.prov in ["GA", "MC", "NC", "PV", "VC"]:
            self[date(year, MAR, 19)] = "San José"
        elif (
            2020 <= year <= 2025
            and self.prov
