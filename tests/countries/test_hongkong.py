...
class TestHongKong(unittest.TestCase):
    ...
    def test_labour_day(self):
        for year in [
            2006, 2007, 2008, 2009, 2010, 2012, 2013, 2014, 2015, 2017, 2018,
            2019, 2020,
        ]:
    ...
    def test_hksar_day(self):
        for year in [
            2006, 2008, 2009, 2010, 2011, 2013, 2014, 2015, 2016, 2017, 2019,
            2020,
        ]:
            self.assertEqual(
                self.holidays[date(year, 7, 1)], "Hong Kong " +
    ...
    def test_national_day(self):
        for year in [
            2007, 2008, 2009, 2010, 2011, 2013, 2014, 2015, 2016, 2018, 2019,
            2020,
        ]:
