...
class TestParaguay(unittest.TestCase):
    ...
    def test_fixed_holidays(self):
        checkdates = (
            date(2016, 1, 1), date(2020, 1, 1), date(2020, 3, 2),
            date(2020, 4, 9), date(2020, 5, 1), date(2020, 5,
                                                     15), date(2020, 6, 15),
            date(2020, 8, 15), date(2020, 9, 29), date(2020, 12,
                                                       8), date(2020, 12, 25),
        )
    ...
    def test_no_observed(self):
        ...
        checkdates = (
            date(2017, 1, 1), date(2014, 3, 2), date(2020, 4, 12),
            date(2016, 5, 1), date(2016, 5, 15), date(2016, 6, 12),
            date(2015, 8, 15), date(2018, 9, 29), date(2018, 12, 8),
        )
