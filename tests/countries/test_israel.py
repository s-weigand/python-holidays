...
class TestIsrael(unittest.TestCase):
    ...
    def _test_observed_holidays(self, holiday_name):
        ...
        official_memorial_day = date(2017, 4,
                                     30) + relativedelta(days=days_delta)
        observed_memorial_day = date(2017, 5,
                                     1) + relativedelta(days=days_delta)
        ...
        official_memorial_day = date(2018, 4,
                                     19) + relativedelta(days=days_delta)
        observed_memorial_day = date(2018, 4,
                                     18) + relativedelta(days=days_delta)
        self.assertIn(official_memorial_day, il_holidays)
        self.assertIn(holiday_name, il_holidays[official_memorial_day])
        self.assertIn(observed_memorial_day, il_holidays)
        self.assertIn(
        ...
        official_memorial_day = date(2020, 4,
                                     28) + relativedelta(days=days_delta)
        self.assertIn(official_memorial_day, il_holidays)
        self.assertIn(holiday_name, il_holidays[official_memorial_day])
