...
class TestBasics(unittest.TestCase):
    ...
    def test_getitem(self):
        ...
        self.assertListEqual(
            self.
            holidays[date(2014, 1, 1):date(2013, 12, 24):timedelta(days=3)],
            [date(2014, 1, 1)],
        )
        self.assertListEqual(
            self.
            holidays[date(2014, 1, 1):date(2013, 12, 24):timedelta(days=7)],
            [date(2014, 1, 1), date(2013, 12, 25)],
        )
        self.assertListEqual(
            self.
            holidays[date(2013, 12, 31):date(2014, 1, 2):timedelta(days=3)], []
        )
    ...
    def test_add(self):
        ...
        self.assertIn("2014-07-04", na)
        provs = holidays.CA(prov="ON", years=[
            2014
